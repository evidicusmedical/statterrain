...
export const facilityTaxonomy: FacilityTaxonomyEntry[] = [
  ...
  },
  {
    ...
    evidenceEligibility: "eligible",
    syntheticOnly: false,
    limitations: ["Critical-access status reflects the current generated CMS hospital record field; unsupported clinical capabilities are still not inferred."],
    reason: "The active national CMS hospital partitions expose a critical-access indicator used by the map loader.",
    nextRequiredSource: null,
  },
  {
    id: "dialysis",

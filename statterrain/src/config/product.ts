...
export const product = {
  ...
  prototypeVersion: "v0.3.6.2 prototype",
  ...
  disclaimer:
    "Planning prototype only. StatTerrain is for education, orientation, quality improvement, and public-data situational awareness. It is not for clinical care, patient-specific decisions, EMS routing, triage, transfer decisions, dispatch, medical control, live diversion, bed availability, or emergency response. CMS hospital facility listings are public source-backed data in normal operation. Developer/demo fixtures, when explicitly enabled, are not real-world sources. Verify facility capability, operating status, maps, and public-data findings with official sources. Population-health metrics remain inactive until source-backed activation; area-level planning context does not describe or diagnose any individual person. This tool does not provide medical, legal, operational, or emergency advice. In an emergency, use local emergency protocols and official emergency communication channels.",
  syntheticDataNotice:

...
test('version and arbitrary fallback removal',()=>{ assert.match(product,/v0\.3\.6\.4 prototype/); for (const old of ['v0.3.3.2 prototype','v0.3.3.1 prototype','v0.3.3 prototype','v0.3.2.4 prototype']) assert.ok(!product.includes(`prototypeVersion: "${old}"`)); assert.ok(!selector.includes('["CA","DC","FL","IL","NY","TX"]')); assert.match(selector,/status:"unresolved"/); });
